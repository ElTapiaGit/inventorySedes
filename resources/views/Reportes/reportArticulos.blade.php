...
<head>
    ...
    <title>Reporte_Equipos_Adquiridos</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="filter-form">
            <form action="{{ route('reportes.equipos-adquiridos') }}" method="GET">
