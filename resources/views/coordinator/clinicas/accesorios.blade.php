...
@section('title', 'Accesorios de la Clinica')
...
<main class="content px-3 pagacces">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-center mb-4">
            <a href="{{ route('clinica.accesorios.equipo') }}" class="btn btn-primary mx-2">Equipo con Accesorios</a>
            <a href="{{ route('clinica.accesorios.unicos') }}" class="btn btn-secondary mx-2">Accesorios Únicos</a>
        </div>
        <!-- Formulario de búsqueda por código -->
        <div class="row mb-3">
            <div class="col-md-6 d-flex justify-content-center align-items-center my-3">
                <form method="GET" action="{{ route('clinica.accesorios.buscarCodigo') }}" class="personaliacces">
            ...
            <div class="col-md-6 d-flex justify-content-center align-items-center " >
                <form method="GET" action="{{ route('clinica.accesorios.buscarNombre') }}" class="personaliacces">
                    <div class="input-group">
                        <span class="input-group-text"><i class="fas fa-search"></i></span>
                ...
                <tbody>
                    @foreach($accesorios as $accesorio)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('clinica.accesorios.show', $accesorio->cod_accesorio) }}" title="Mas Informacion">
