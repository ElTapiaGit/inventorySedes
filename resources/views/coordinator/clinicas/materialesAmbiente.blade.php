...
@section('title', 'Materiales del Ambiente')

@section('content')
<main class="content px-3 ambiente-clinica">
    <div class="container-fluid">
        <div class="mb-3">
            <h3 class="text-center titulo fw-bold">Materiales del Ambiente: {{ $ambiente->nombre }}</h3>
        </div>
        ...
        <script>
            Swal.fire({
                icon: 'info',
                title: 'No existen materiales en el Ambiende -- {{ $ambiente->nombre }}',
                ...
                <tbody>
                    ...
                    @foreach($materiales as $material)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('clinica.material.detalles', ['token' => Crypt::encrypt($material->cod_mate)]) }}" title="Detalles">
