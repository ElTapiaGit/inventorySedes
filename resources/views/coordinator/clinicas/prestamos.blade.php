    ...
    <div class="container-fluid">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6 d-flex justify-content-center">
                <form method="GET" action="{{ route('clinica.prestamos.buscar') }}" class="d-flex align-items-center">
                    @csrf
                    <input type="text" class="form-control me-2 w-75" id="usuario" name="usuario" placeholder="Nombre Prestatario">
                    ...
                    @foreach($prestamos as $prestamo)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('clinica.prestamos.detalles', ['token' => Crypt::encrypt($prestamo->id_prestamo)]) }}" title="Detalles">
...
<!--mensaje de cuando no hay resultado en las busquedas-->
@if(session('error_usuario'))
    <script>
        Swal.fire({
            ...
            window.location.href = "{{ route('clinica.prestamos.index') }}";
        });
    </script>
@endif
