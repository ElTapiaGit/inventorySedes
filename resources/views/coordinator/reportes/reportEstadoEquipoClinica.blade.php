...
<body>
    <div class="container">
        ...
        <div class="filter-form">
            <form action="{{ route('report.estado.equiposClinica') }}" method="GET">
                ...
                <input type="text" id="nombre_equi" name="nombre_equi" value="{{ request('nombre_equi') }}" placeholder="Buscar por nombre">
